<script>
    ...
    let assignments = [
        {title: "Analytical Essay or Research Paper", icon: "/reflection_response_number_3.png", docID: "1gGwD5fEqQgll1SuAHNoxNyWa5TXZksinUd0Fhn25jmM"},
        ...
        {title: "Reflection or Response Paper", icon: "/new_refl_cloud.png", docID: "1vNMvoXP1k9yb4IZDNajriQwmkfNZtf6-A_I4fNLXD6Q"},
        ...
        {#if visible && altLayout}
            <div use:readAssignments tabindex="0" on:keydown={keyAssignment} class="alt-layout-container" transition:fade>
                ...
                <div class="alt-layout-elem">
                    <div class="alt-item">
                        <img style="width: 150px;height:auto;" on:click={selectAssignmentType} id={assignment.title} alt={assignment.title} src={assignment.icon_url}>
                    </div>
                ...
                {/if}
                    ...
                    {#if selectedStartDate != undefined}
                        <div style="display: flex;flex-direction:column;align-items:center;" transition:fade>
                            <SveltyPicker clearBtn={false} todayBtn={false} pickerOnly startDate={selectedStartDate} bind:value={selectedEndDate} />
        ...
        <div class="m-fp-container">
            ...
            {#if visible}
                <div class="m-grid-container" transition:fade>
                    ...
                    {#each assignments as assignment}
                        <div class="grid-assign">
                            <img on:click={selectAssignmentType} id={assignment.title} class="m-grid-item" alt={assignment.title} src={assignment.icon_url}>
